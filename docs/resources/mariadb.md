---
page_title: "samsungcloudplatform_mariadb Resource - samsungcloudplatform"
subcategory: "MariaDB"
description: |-
  Provides a Mariadb Database resource.
---

# samsungcloudplatform_mariadb (Resource)
...
- `mariadb_servers` (Block List, Min: 1, Max: 2) Mariadb servers (HA configuration when entering two server specifications) (see [below for nested schema](#nestedblock--mariadb_servers))
