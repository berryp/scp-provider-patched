...
- `epas_servers` (Block List, Min: 1, Max: 2) epas servers (HA configuration when entering two server specifications) (see [below for nested schema](#nestedblock--epas_servers))
