...
type EpasBlockStorageGroupCreateRequest struct {
	BlockStorageRoleType string `json:"blockStorageRoleType"`
	BlockStorageSize     int32  `json:"blockStorageSize"`
	BlockStorageType     string `json:"blockStorageType,omitempty"`
}

type EpasBlockStorageGroupDetailResponse struct {
...
type EpasClusterAddBlockStoragesRequest struct {
	BlockStorageRoleType string `json:"blockStorageRoleType"`
	BlockStorageSize     int32  `json:"blockStorageSize"`
	BlockStorageType     string `json:"blockStorageType,omitempty"`
}

type EpasClusterCreateRequest struct {
	AuditEnabled      *bool                                   `json:"auditEnabled,omitempty"`
	EpasClusterName   string                                  `json:"epasClusterName"`
	EpasInitialConfig *EpasInitialConfigCreateRequest `json:"epasInitialConfig"`
	EpasServerGroup   *EpasServerGroupCreateRequest   `json:"epasServerGroup"`
	ImageId           string                                  `json:"imageId"`
...
type EpasClusterDetailResponse struct {
	...
	EpasClusterId         string                                   `json:"epasClusterId,omitempty"`
	EpasClusterName       string                                   `json:"epasClusterName,omitempty"`
	EpasClusterState      string                                   `json:"epasClusterState,omitempty"`
	EpasInitialConfig     *EpasInitialConfigDetailResponse `json:"epasInitialConfig,omitempty"`
	EpasMasterClusterId   string                                   `json:"epasMasterClusterId,omitempty"`
	EpasReplicaClusterIds []string                                 `json:"epasReplicaClusterIds,omitempty"`
	EpasServerGroup       *EpasServerGroupDetailResponse   `json:"epasServerGroup,omitempty"`
	ImageId               string                                   `json:"imageId,omitempty"`
...
type EpasClusterListItemResponse struct {
	ProjectId        string       `json:"projectId,omitempty"`
	BlockId          string       `json:"blockId,omitempty"`
	EpasClusterId    string       `json:"epasClusterId,omitempty"`
	EpasClusterName  string       `json:"epasClusterName,omitempty"`
...
type EpasClusterResizeBlockStoragesRequest struct {
	BlockStorageGroupId string `json:"blockStorageGroupId"`
	BlockStorageSize    int32  `json:"blockStorageSize"`
}

type EpasClusterResizeVirtualServersRequest struct {
	ServerType string `json:"serverType"`
}

type EpasConfigurationControllerApiListEpasOpts struct {
...
type EpasInitialConfigCreateRequest struct {
...
type EpasInitialConfigDetailResponse struct {
...
type EpasSearchApiListEpasClustersOpts struct {
	EpasClusterName optional.String
	Page            optional.Int32
	Size            optional.Int32
	Sort            optional.Interface
}

type EpasServerCreateRequest struct {
	AvailabilityZoneName string `json:"availabilityZoneName,omitempty"`
	EpasServerName       string `json:"epasServerName"`
	ServerRoleType       string `json:"serverRoleType"`
}

type EpasServerDetailResponse struct {
	AvailabilityZoneName string       `json:"availabilityZoneName,omitempty"`
	EpasServerId         string       `json:"epasServerId,omitempty"`
	EpasServerName       string       `json:"epasServerName,omitempty"`
	EpasServerState      string       `json:"epasServerState,omitempty"`
...
type EpasServerGroupCreateRequest struct {
	BlockStorages     []EpasBlockStorageGroupCreateRequest `json:"blockStorages"`
	EncryptionEnabled *bool                                        `json:"encryptionEnabled,omitempty"`
	EpasServers       []EpasServerCreateRequest            `json:"epasServers"`
	ServerType        string                                       `json:"serverType"`
}

type EpasServerGroupDetailResponse struct {
	BlockStorages       []EpasBlockStorageGroupDetailResponse `json:"blockStorages,omitempty"`
	EncryptionEnabled   *bool                                         `json:"encryptionEnabled,omitempty"`
	EpasServers         []EpasServerDetailResponse            `json:"epasServers,omitempty"`
...
type ListResponseEpasClusterListItemResponse struct {
	Contents   []EpasClusterListItemResponse `json:"contents,omitempty"`
	TotalCount int32                                 `json:"totalCount,omitempty"`
}
