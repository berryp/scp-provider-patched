...
type ArchiveLogDeleteRequest struct {
	ArchiveLogDeleteType string `json:"archiveLogDeleteType"`
}
...
type ListResponsePostgresqlClusterListItemResponse struct {
	Contents   []PostgresqlClusterListItemResponse `json:"contents,omitempty"`
	TotalCount int32                                             `json:"totalCount,omitempty"`
}
...
type PostgreSqlConfigurationControllerApiListPostgresqlOpts struct {
...
type PostgresqlBlockStorageGroupCreateRequest struct {
	BlockStorageRoleType string `json:"blockStorageRoleType"`
	BlockStorageSize     int32  `json:"blockStorageSize"`
	BlockStorageType     string `json:"blockStorageType,omitempty"`
}

type PostgresqlBlockStorageGroupDetailResponse struct {
...
type PostgresqlClusterAddBlockStoragesRequest struct {
	BlockStorageRoleType string `json:"blockStorageRoleType"`
	BlockStorageSize     int32  `json:"blockStorageSize"`
	BlockStorageType     string `json:"blockStorageType,omitempty"`
}
...
type PostgresqlClusterCreateRequest struct {
	...
	PostgresqlClusterName   string                                              `json:"postgresqlClusterName"`
	PostgresqlInitialConfig *PostgresqlInitialConfigCreateRequest `json:"postgresqlInitialConfig"`
	PostgresqlServerGroup   *PostgresqlServerGroupCreateRequest   `json:"postgresqlServerGroup"`
	SecurityGroupIds        []string                                            `json:"securityGroupIds"`
	ServiceZoneId           string                                              `json:"serviceZoneId"`
	SubnetId                string                                              `json:"subnetId"`
	Tags                    []TagRequest                          `json:"tags,omitempty"`
...
type PostgresqlClusterDetailResponse struct {
	ProjectId                   string                                               `json:"projectId,omitempty"`
	AuditEnabled                *bool                                                `json:"auditEnabled,omitempty"`
	...
	PostgresqlClusterId         string                                               `json:"postgresqlClusterId,omitempty"`
	PostgresqlClusterName       string                                               `json:"postgresqlClusterName,omitempty"`
	PostgresqlClusterState      string                                               `json:"postgresqlClusterState,omitempty"`
	PostgresqlInitialConfig     *PostgresqlInitialConfigDetailResponse `json:"postgresqlInitialConfig,omitempty"`
	PostgresqlMasterClusterId   string                                               `json:"postgresqlMasterClusterId,omitempty"`
	PostgresqlReplicaClusterIds []string                                             `json:"postgresqlReplicaClusterIds,omitempty"`
	PostgresqlServerGroup       *PostgresqlServerGroupDetailResponse   `json:"postgresqlServerGroup,omitempty"`
	SecurityGroupIds            []string                                             `json:"securityGroupIds,omitempty"`
	ServiceZoneId               string                                               `json:"serviceZoneId,omitempty"`
...
type PostgresqlClusterListItemResponse struct {
	ProjectId              string       `json:"projectId,omitempty"`
	BlockId                string       `json:"blockId,omitempty"`
	PostgresqlClusterId    string       `json:"postgresqlClusterId,omitempty"`
	PostgresqlClusterName  string       `json:"postgresqlClusterName,omitempty"`
...
type PostgresqlClusterResizeBlockStoragesRequest struct {
	BlockStorageGroupId string `json:"blockStorageGroupId"`
	BlockStorageSize    int32  `json:"blockStorageSize"`
}

type PostgresqlClusterResizeVirtualServersRequest struct {
	ServerType string `json:"serverType"`
}

type PostgresqlInitialConfigCreateRequest struct {
	DatabaseEncoding     string `json:"databaseEncoding"`
	DatabaseLocale       string `json:"databaseLocale"`
...
type PostgresqlInitialConfigDetailResponse struct {
	DatabaseEncoding string `json:"databaseEncoding,omitempty"`
	DatabaseLocale   string `json:"databaseLocale,omitempty"`
	DatabaseName     string `json:"databaseName,omitempty"`
	DatabasePort     int32  `json:"databasePort,omitempty"`
	DatabaseUserName string `json:"databaseUserName,omitempty"`
}

type PostgresqlSearchApiListPostgresqlClustersOpts struct {
	PostgresqlClusterName optional.String
	Page                  optional.Int32
	Size                  optional.Int32
	Sort                  optional.Interface
}

type PostgresqlServerCreateRequest struct {
	AvailabilityZoneName string `json:"availabilityZoneName,omitempty"`
	PostgresqlServerName string `json:"postgresqlServerName"`
	ServerRoleType       string `json:"serverRoleType"`
}

type PostgresqlServerDetailResponse struct {
	AvailabilityZoneName  string       `json:"availabilityZoneName,omitempty"`
	PostgresqlServerId    string       `json:"postgresqlServerId,omitempty"`
	PostgresqlServerName  string       `json:"postgresqlServerName,omitempty"`
	PostgresqlServerState string       `json:"postgresqlServerState,omitempty"`
...
type PostgresqlServerGroupCreateRequest struct {
	BlockStorages     []PostgresqlBlockStorageGroupCreateRequest `json:"blockStorages"`
	EncryptionEnabled *bool                                                    `json:"encryptionEnabled,omitempty"`
	PostgresqlServers []PostgresqlServerCreateRequest            `json:"postgresqlServers"`
	ServerType        string                                                   `json:"serverType"`
}

type PostgresqlServerGroupDetailResponse struct {
	BlockStorages       []PostgresqlBlockStorageGroupDetailResponse `json:"blockStorages,omitempty"`
	EncryptionEnabled   *bool                                                     `json:"encryptionEnabled,omitempty"`
	PostgresqlServers   []PostgresqlServerDetailResponse            `json:"postgresqlServers,omitempty"`
