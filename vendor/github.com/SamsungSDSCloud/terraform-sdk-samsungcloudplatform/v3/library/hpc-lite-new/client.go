...
type APIClient struct {
	...
	common service
	HpcLitePlusOpenAPIV1ControllerApi *HpcLitePlusOpenAPIV1ControllerApiService
	Client *Client
}
...
type HpcLitePlusOpenAPIV1ControllerApiService service
type Client service

func NewAPIClient(cfg *scpsdk.Configuration) *APIClient {
	c := &APIClient{cfg: cfg}
	c.common.client = c
	c.HpcLitePlusOpenAPIV1ControllerApi = (*HpcLitePlusOpenAPIV1ControllerApiService)(&c.common)
