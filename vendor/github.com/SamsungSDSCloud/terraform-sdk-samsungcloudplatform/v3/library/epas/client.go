...
type APIClient struct {
	...
	EpasBackupApi *EpasBackupApiService
	EpasConfigurationControllerApi *EpasConfigurationControllerApiService
	EpasInfraResourceApi *EpasInfraResourceApiService
	EpasNetworkApi *EpasNetworkApiService
	EpasOperationManagementApi *EpasOperationManagementApiService
	EpasPricingApi *EpasPricingApiService
	EpasProvisioningApi *EpasProvisioningApiService
	EpasSearchApi *EpasSearchApiService
	Client *Client
}
...
type EpasBackupApiService service
type EpasConfigurationControllerApiService service
type EpasInfraResourceApiService service
type EpasNetworkApiService service
type EpasOperationManagementApiService service
type EpasPricingApiService service
type EpasProvisioningApiService service
type EpasSearchApiService service
type Client service
...
func NewAPIClient(cfg *scpsdk.Configuration) *APIClient {
	...
	c.EpasBackupApi = (*EpasBackupApiService)(&c.common)
	c.EpasConfigurationControllerApi = (*EpasConfigurationControllerApiService)(&c.common)
	c.EpasInfraResourceApi = (*EpasInfraResourceApiService)(&c.common)
	c.EpasNetworkApi = (*EpasNetworkApiService)(&c.common)
	c.EpasOperationManagementApi = (*EpasOperationManagementApiService)(&c.common)
	c.EpasPricingApi = (*EpasPricingApiService)(&c.common)
	c.EpasProvisioningApi = (*EpasProvisioningApiService)(&c.common)
	c.EpasSearchApi = (*EpasSearchApiService)(&c.common)
