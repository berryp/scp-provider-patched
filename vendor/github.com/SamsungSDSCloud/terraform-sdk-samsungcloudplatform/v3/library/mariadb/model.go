...
type ListResponseMariadbClusterListItemResponse struct {
	Contents   []MariadbClusterListItemResponse `json:"contents,omitempty"`
	TotalCount int32                                       `json:"totalCount,omitempty"`
}
...
type MariaDbConfigurationControllerApiListMariadbOpts struct {
...
type MariadbBlockStorageGroupCreateRequest struct {
	BlockStorageRoleType string `json:"blockStorageRoleType"`
	BlockStorageSize     int32  `json:"blockStorageSize"`
	BlockStorageType     string `json:"blockStorageType,omitempty"`
}

type MariadbBlockStorageGroupDetailResponse struct {
...
type MariadbClusterAddBlockStoragesRequest struct {
	BlockStorageRoleType string `json:"blockStorageRoleType"`
	BlockStorageSize     int32  `json:"blockStorageSize"`
	BlockStorageType     string `json:"blockStorageType,omitempty"`
}
...
type MariadbClusterCreateRequest struct {
	...
	ImageId              string                                        `json:"imageId"`
	MariadbClusterName   string                                        `json:"mariadbClusterName"`
	MariadbInitialConfig *MariadbInitialConfigCreateRequest `json:"mariadbInitialConfig"`
	MariadbServerGroup   *MariadbServerGroupCreateRequest   `json:"mariadbServerGroup"`
...
type MariadbClusterDetailResponse struct {
	...
	MariadbClusterId         string                                         `json:"mariadbClusterId,omitempty"`
	MariadbClusterName       string                                         `json:"mariadbClusterName,omitempty"`
	MariadbClusterState      string                                         `json:"mariadbClusterState,omitempty"`
	MariadbInitialConfig     *MariadbInitialConfigDetailResponse `json:"mariadbInitialConfig,omitempty"`
	MariadbMasterClusterId   string                                         `json:"mariadbMasterClusterId,omitempty"`
	MariadbReplicaClusterIds []string                                       `json:"mariadbReplicaClusterIds,omitempty"`
	MariadbServerGroup       *MariadbServerGroupDetailResponse   `json:"mariadbServerGroup,omitempty"`
...
type MariadbClusterListItemResponse struct {
	ProjectId           string       `json:"projectId,omitempty"`
	BlockId             string       `json:"blockId,omitempty"`
	MariadbClusterId    string       `json:"mariadbClusterId,omitempty"`
	MariadbClusterName  string       `json:"mariadbClusterName,omitempty"`
...
type MariadbClusterResizeBlockStoragesRequest struct {
	BlockStorageGroupId string `json:"blockStorageGroupId"`
	BlockStorageSize    int32  `json:"blockStorageSize"`
}

type MariadbClusterResizeVirtualServersRequest struct {
	ServerType string `json:"serverType"`
}

type MariadbInitialConfigCreateRequest struct {
...
type MariadbInitialConfigDetailResponse struct {
...
type MariadbSearchApiListMariadbClustersOpts struct {
	MariadbClusterName optional.String
	Page               optional.Int32
	Size               optional.Int32
	Sort               optional.Interface
}

type MariadbServerCreateRequest struct {
	AvailabilityZoneName string `json:"availabilityZoneName,omitempty"`
	MariadbServerName    string `json:"mariadbServerName"`
	ServerRoleType       string `json:"serverRoleType"`
}

type MariadbServerDetailResponse struct {
	AvailabilityZoneName string       `json:"availabilityZoneName,omitempty"`
	MariadbServerId      string       `json:"mariadbServerId,omitempty"`
	MariadbServerName    string       `json:"mariadbServerName,omitempty"`
	MariadbServerState   string       `json:"mariadbServerState,omitempty"`
...
type MariadbServerGroupCreateRequest struct {
	BlockStorages     []MariadbBlockStorageGroupCreateRequest `json:"blockStorages"`
	EncryptionEnabled *bool                                              `json:"encryptionEnabled,omitempty"`
	MariadbServers    []MariadbServerCreateRequest            `json:"mariadbServers"`
	ServerType        string                                             `json:"serverType"`
}

type MariadbServerGroupDetailResponse struct {
	BlockStorages       []MariadbBlockStorageGroupDetailResponse `json:"blockStorages,omitempty"`
	EncryptionEnabled   *bool                                               `json:"encryptionEnabled,omitempty"`
	MariadbServers      []MariadbServerDetailResponse            `json:"mariadbServers,omitempty"`
